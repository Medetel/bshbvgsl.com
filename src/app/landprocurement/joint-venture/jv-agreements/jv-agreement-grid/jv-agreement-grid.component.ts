...
@Component({
  selector: 'app-jv-agreement-grid',
  templateUrl: './jv-agreement-grid.component.html',
  styleUrls: ['./jv-agreement-grid.component.css']
})
export class JvAgreementGridComponent implements OnInit {
  title="Agreement";
  ...
  GetAllLandPurchase(itemsPerPage: number, pageNo: number){
    ...
    this.data = this.userService.GetJVAgreement(itemsPerPage,pageNo);
    this.data.subscribe(
         (response: any) => {          
