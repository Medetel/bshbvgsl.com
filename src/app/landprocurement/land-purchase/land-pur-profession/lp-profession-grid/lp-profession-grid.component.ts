...
@Component({
  selector: 'app-lp-profession-grid',
  templateUrl: './lp-profession-grid.component.html',
  styleUrls: ['./lp-profession-grid.component.css']
})
export class LpProfessionGridComponent implements OnInit {
  title="Possession";
  ...
  GetAllLandPurchase(itemsPerPage: number, pageNo: number){
    ...
    this.data = this.userService.Getpossession(itemsPerPage,pageNo);
    this.data.subscribe(
         (response: any) => {          
