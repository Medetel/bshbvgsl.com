...
@Component({
  selector: 'app-land-project-grid',
  templateUrl: './land-project-grid.component.html',
  styleUrls: ['./land-project-grid.component.css']
})
export class LandProjectGridComponent implements OnInit {
