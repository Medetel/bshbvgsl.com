...
@Component({
  selector: 'app-landprocurement-menu',
  templateUrl: './landprocurement-menu.component.html',
  styleUrls: ['./landprocurement-menu.component.css']
})
export class LandprocurementMenuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    for(let i=0; i<this.menuList.length; i++){
      if(this.menuList[i].KHB_MenuName=='Land Procurement')
