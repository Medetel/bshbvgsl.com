...
@Component({
  selector: 'app-approved-drawing-grid',
  templateUrl: './approved-drawing-grid.component.html',
  styleUrls: ['./approved-drawing-grid.component.css']
})
export class ApprovedDrawingGridComponent implements OnInit {
