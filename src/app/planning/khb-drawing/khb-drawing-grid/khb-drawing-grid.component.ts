...
@Component({
  selector: 'app-khb-drawing-grid',
  templateUrl: './khb-drawing-grid.component.html',
  styleUrls: ['./khb-drawing-grid.component.css']
})
export class KhbDrawingGridComponent implements OnInit {
  title = "Drawing by BSHB List"
  KhbDrawinglist;
  s: Search;
