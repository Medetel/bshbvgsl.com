...
@Component({
  selector: 'app-revised-drawing-grid',
  templateUrl: './revised-drawing-grid.component.html',
  styleUrls: ['./revised-drawing-grid.component.css']
})
export class RevisedDrawingGridComponent implements OnInit {
