...
@Component({
  selector: 'app-khb-challan',
  templateUrl: './khb-challan.component.html',
  styleUrls: ['./khb-challan.component.css']
})
export class khbChallanComponent implements OnInit {
