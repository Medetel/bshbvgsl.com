...
@Component({
  selector: 'app-dividend-grid',
  templateUrl: './dividend-grid.component.html',
  styleUrls: ['./dividend-grid.component.css']
})
export class DividendGridComponent implements OnInit {
...
//   this.data = this.userService.GetAllEmployeeBankDetails(itemsPerPage,pageNo);
//   this.data.subscribe(
//        (response: any) => {
...
//       document.getElementById('loader-spinner').style.display = "block";
//       this.userService.GetEmployeeBankDetailsOnSearch(itemsPerPage,pageNo,searchCriteria,searchText)
//       //ItemsPerPage, pageno, searchBy, searchValue
//         .subscribe(
//           (data:any) => {            
//               this.EmployeeBankDetails= data.HRMSEmpBankDetails;
