...
@Component({
  selector: 'app-pr-vacant-prop-list',
  templateUrl: './pr-vacant-prop-list.component.html',
  styleUrls: ['./pr-vacant-prop-list.component.css']
})
export class PrVacantPropListComponent implements OnInit {
  ...
  constructor(private userService: UserService, private router: Router, private route: ActivatedRoute,private errorHandler: ErrorHandler,
    ...
    GetList(SearchForm){    
      ...
      document.getElementById('loader-spinner').style.display = "block";
      this.data = this.userService.GetProjectwiseVacantList(SearchForm.value.District_Id_FK,SearchForm.value.ProjectId,SearchForm.value.CategoryId);
      this.data.subscribe(
        (response: any) => {
