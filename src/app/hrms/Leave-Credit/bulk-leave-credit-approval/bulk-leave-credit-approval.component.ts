...
@Component({
  selector: 'app-bulk-leave-credit-approval',
  templateUrl: './bulk-leave-credit-approval.component.html',
  styleUrls: ['./bulk-leave-credit-approval.component.css']
})
export class BulkLeaveCreditApprovalComponent implements OnInit {
  title=""
 ...
 getDefaultData(){
  ...
  ChangeOfDivision(Id){
    ...
    this.data = this.userService.uspGetLeavecreditBulkforApproveSanction(Id,'G');
    this.data.subscribe(
         (response: any) => {
