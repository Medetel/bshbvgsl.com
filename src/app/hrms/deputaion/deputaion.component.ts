...
@Component({
  selector: 'app-deputaion',
  templateUrl: './deputaion.component.html',
  styleUrls: ['./deputaion.component.css']
})
export class DeputaionComponent implements OnInit {
  menusList: any;
  pagesList: any;
  subpageslist: any;
  localurl : any;
  ...
  ngOnInit() {
    ...
    for (let j = 0; j < this.pagesList.length; j++) {
      if (this.pagesList[j].KHB_Page == 'Deputation')
