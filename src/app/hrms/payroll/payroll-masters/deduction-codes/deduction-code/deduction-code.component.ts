...
@Component({
  selector: 'app-deduction-code',
  templateUrl: './deduction-code.component.html',
  styleUrls: ['./deduction-code.component.css']
})
export class DeductionCodeComponent implements OnInit {
    ...
    if (details.invalid) {
      ...
      this.data.subscribe(
        (response) => {
          ...
          swal('Success!', 'Deduction Details Added Successfully .', 'success');
          this.router.navigate(['/home/payroll/deduction-code-grid']);       
