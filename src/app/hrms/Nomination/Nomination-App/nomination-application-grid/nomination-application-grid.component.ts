...
@Component({
  selector: 'app-nomination-application-grid',
  templateUrl: './nomination-application-grid.component.html',
  styleUrls: ['./nomination-application-grid.component.css']
})
export class NominationApplicationGridComponent implements OnInit {
...
NMNT_ID:number;
  ...
  GetAllNomineeDetails(itemsPerPage: number, pageNo: number) {
    ...
    this.userService.GetAllNomineeDetails(itemsPerPage, pageNo)
      .subscribe(
        (data: any) => {
