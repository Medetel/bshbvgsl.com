...
@Component({
  ...
  styleUrls: ['./nomination-application.component.css']
})
export class NominationApplicationComponent implements OnInit {
  ...
  GetDependent(EMP_EMPLOYEE_ID) {
    debugger;
    this.data = this.userService.GetDependent(EMP_EMPLOYEE_ID);
    this.data.subscribe(
      (response: any) => {
  ...
  GetDependent2(EMP_EMPLOYEE_ID) {
    debugger;
    this.data = this.userService.GetDependent2(EMP_EMPLOYEE_ID);
    this.data.subscribe(
      (response: any) => {
  ...
  GetDependent3(EMP_EMPLOYEE_ID) {
    debugger;
    this.data = this.userService.GetDependent3(EMP_EMPLOYEE_ID);
    this.data.subscribe(
      (response: any) => {
  ...
  GetRelationshipwith(DEPND_ID) {
    debugger;
    this.data = this.userService.GetRelationshipwith(DEPND_ID);
    this.data.subscribe(
      (response: any) => {
  ...
  SaveNominee(Nom: NgForm) {
    ...
    if (Nom.invalid) {
      ...
      this.data = this.userService.PostNom(Nom.value);
      this.data.subscribe(
        (response) => {
          Nom.reset();
          Nom.resetForm();
