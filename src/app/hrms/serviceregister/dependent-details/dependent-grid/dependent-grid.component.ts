...
@Component({
  selector: 'app-dependent-grid',
  templateUrl: './dependent-grid.component.html',
  styleUrls: ['./dependent-grid.component.css']
})
export class DependentGridComponent implements OnInit {
