...
@Component({
  selector: 'app-experiencedetails-grid',
  templateUrl: './experiencedetails-grid.component.html',
  styleUrls: ['./experiencedetails-grid.component.css']
})
export class ExperiencedetailsGridComponent implements OnInit {

  title = "Update Employee Experience Details";
  ...
  //   // else
  //     this.GetEmployeeExperienceDetails(itemsPerPage, pageNo);
  // }
  ...
  //   else
  //     this.GetEmployeeExperienceDetails(this.itemsPerPage, pageNumber);
  // }
  ...
  //   this.data = this.userService.GetAllEmployeeExperience(itemsPerPage, pageNo);
  //   this.data.subscribe(
  //     (response: any) => {
  ...
  //     document.getElementById('loader-spinner').style.display = "block";
  //     this.userService.GetEmployeeExperienceDetailsOnSearch(itemsPerPage, pageNo, searchCriteria, searchText)       
  //       .subscribe(
  //         (data: any) => {
  //           this.EmployeeExperienceDetails = data.EMP_Experience;
