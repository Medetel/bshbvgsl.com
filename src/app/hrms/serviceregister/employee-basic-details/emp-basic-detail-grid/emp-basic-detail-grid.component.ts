...
@Component({
  selector: 'app-emp-basic-detail-grid',
  templateUrl: './emp-basic-detail-grid.component.html',
  styleUrls: ['./emp-basic-detail-grid.component.css']
})
export class EmpBasicDetailGridComponent implements OnInit {
